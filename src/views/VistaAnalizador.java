...
public class VistaAnalizador extends JFrame {
    ...
    public VistaAnalizador() {
        ...
        try {
            aplicarTema("/org/fife/ui/rsyntaxtextarea/themes/monokai.xml"); // tema por defecto
        } catch (Exception e) {
            e.printStackTrace();
        }
...
*/
    ...
    private void inicializarMenus() {
        ...
        intellijItem.addActionListener(e -> cambiarTema("/org/fife/ui/rsyntaxtextarea/themes/intellij.xml"));

        temaSubMenu.add(monokaiItem);
        temaSubMenu.add(eclipseItem);
        temaSubMenu.add(intellijItem);
